  ...
  return (
    <div className='min-h-screen h-full w-full flex flex-col items-center bg-[#ffffff]'>
      <div className="bg-[#6f6f6f] h-20 sm:w-full w-full flex items-center justify-center shadow-xl/10">
        ...
        <h1 className='lg:text-5xl sm:text-3xl text-white ml-3'>Pokédex</h1>
      </div>
      ...
      <div className='w-4/5 grid sm:grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 gap-4 justify-items-center'>
